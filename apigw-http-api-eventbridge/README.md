...
Learn more about this pattern at Serverless Land Patterns: https://serverlessland.com/patterns/apigateway-http-eventbridge
...
1. Change directory to the pattern directory:
    ```
    cd serverless-patterns/apigw-http-api-eventbridge
    ```
