...
1. Change directory to the pattern directory:
    ```
    cd serverless-patterns/apigateway-rest-rest
    ```
...
The stack creates and outputs three endpoints. A primary endpont and two subordinate endpoints. Test the endpoints with the folowing:

```
<primary endpoint>/admin/users
<primary endpoint>/admin/reports
```

You should receive a 200 response and a message from the endpoint.

Testing the direct links for the `UserManagementEndpoint` and `ReportingEndpoint` will result in a 403
