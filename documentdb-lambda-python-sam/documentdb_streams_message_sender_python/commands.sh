...
python3 /home/ec2-user/serverless-patterns/documentdb-lambda-python-sam/python/documentdb_streams_message_sender_python/documentdb_streams_producer.py DOCDB_DATABASE DOCDB_COLLECTION $1 $2
