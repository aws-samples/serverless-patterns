...
1. Change directory to the pattern directory:
    ```
    cd eventbridge-pipes-kinesis-to-timestream
    ```
...
The template will create a Timestream table, Kinesis Stream, SQS Queue and an IAM Role, and connect it together with a new EventBridge Pipe.
