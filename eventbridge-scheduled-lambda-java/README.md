...
This is a Java port of the [original pattern](https://serverlessland.com/patterns/eventbridge-scheduled-lambda).
...
1. Change directory to the pattern directory:
    ```
    cd eventbridge-scheduled-lambda-java
    ```
...
This SAM template creates a Lambda function that logs details of the Event Bridge event to cloudwatch logs every minute.
