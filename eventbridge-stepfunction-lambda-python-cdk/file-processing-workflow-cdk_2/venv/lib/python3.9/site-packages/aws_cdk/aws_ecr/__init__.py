...
class CfnPublicRepository(
    ...
    def __init__(
        ...
        *,
        ...
        :param repository_catalog_data: The CatalogData property type specifies Catalog data for ECR Public Repository. For information about Catalog Data, see
...
class CfnPublicRepositoryProps:
    ...
    def repository_catalog_data(self) -> typing.Any:
        ...
        For information about Catalog Data, see
