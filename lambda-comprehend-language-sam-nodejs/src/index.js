...
exports.handler = async (event) => {
  ...
  try { 
    // Call the DetectDominantLanguageAPI
    const command = new DetectDominantLanguageCommand(params);
    const response = await client.send(command);
    // Obtaining language code and confidence score
    ...
    return {
      ...
      return {
        statusCode: 200,
        message: JSON.stringify("Language not supported. Please refer - https://docs.aws.amazon.com/comprehend/latest/dg/how-languages.html.l")}
    }
