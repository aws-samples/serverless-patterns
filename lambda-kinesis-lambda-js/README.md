...
Learn more about this pattern at Serverless Land Patterns: [https://serverlessland.com/patterns/lambda-kinesis-lambda-js](https://serverlessland.com/patterns/lambda-kinesis-lambda-js)
...
1. Change directory to the pattern directory:
    ```
    cd lambda-kinesis-lambda-js
    ```
1. From the command line, use AWS SAM to build your stack:
    ```
    sam build
    ```
1. Once, the build command is successful, deploy the AWS resources for the pattern as specified in the template.yml file:
    ```
    sam deploy --guided
    ```
