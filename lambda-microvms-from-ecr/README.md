# Run an AWS Lambda MicroVM from an Amazon ECR image
...
Learn more about this pattern at Serverless Land Patterns: https://serverlessland.com/patterns/lambda-microvms-from-ecr
...
## How it differs from the [zip pattern](https://serverlessland.com/patterns/lambda-microvms-from-zip)
...
`deploy.sh` automates all the deployment steps below (including Docker build and ECR push). It creates an S3 bucket, ECR repository, IAM role, and MicroVM image in your account.
