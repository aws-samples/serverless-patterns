# Python Lambda Kafka Consumer with IAM Auth, using SAM
...
* Install [Python3.9](https://www.python.org/downloads/release/python-3917/)
...
This pattern created a Lambda function along with a Lambda Event Source Mapping(ESM), which as the name implies, maps that Lambda function to an Event Source, in this case a Kafka Topic on an MSK Cluster. The ESM takes care of polling the Kafka Topic and then invokes the Lambda function with a batch of messages.
