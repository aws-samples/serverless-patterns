...
/**
 * Construct to create a Fargate service with an ALB or NLB
 * @param {IVpc} props.vpc The VPC to create the service in
 * @param {string} props.loadbalancerType The type of load balancer to create. Either ALB or NLB
 */
export class MyFargateService extends Construct {
  ...
  constructor(scope: Construct, id: string, props: MyFargateServiceProps) {
    ...
    // Create Fargate for ECS based on the type of load balancer passed in the prop
