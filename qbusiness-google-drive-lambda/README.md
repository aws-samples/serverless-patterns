...
![Configure Secrets](images/configure-secrets.png) Click next, then enter a name for your secret and click next. Click next and then store on the following screens.
