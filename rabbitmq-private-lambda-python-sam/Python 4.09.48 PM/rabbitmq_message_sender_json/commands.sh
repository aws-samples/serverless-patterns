...
python3 /home/ec2-user/serverless-patterns/rabbitmq-private-lambda-python-sam/Python/rabbitmq_message_sender_json/rabbitmq_producer.py $broker_endpoint_without_port RABBITMQ_VIRTUAL_HOST RABBITMQ_EXCHANGE RABBITMQ_QUEUE_NAME $1 $2
