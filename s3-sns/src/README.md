...
This SAM template creates an S3 bucket, allows you to upload objects to that bucket, and will send you notifications from S3 to SNS when an object is created in that bucket. You must create a subscription from the SNS console first. 
