...
Once the application is deployed, you can test it by entering the cloudfront url in a browser. Refer to https://webapp.serverlessworkshops.io for further information on how the application works
