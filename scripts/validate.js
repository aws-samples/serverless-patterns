      ...
      if (githubAutomation) {
        ...
        await octokit.rest.issues.createComment({
          ...
          body:
            ...
            `Reviewer you can view the [pattern file here](https://beta.serverlessland.com/patterns/pattern-example?repo${forkURL}&pattern=${encodeURIComponent(JSON.stringify(parsedJSON))}) \n\n`,
        });
