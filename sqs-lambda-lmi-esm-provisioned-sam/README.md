...
* [AWS Serverless Application Model](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/serverless-sam-cli-install.html) (AWS SAM) installed — **v1.158.0 or later required** (first version supporting `AWS::Serverless::CapacityProvider` and LMI resources)
