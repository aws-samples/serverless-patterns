...
Lambda packaging lives in the root Makefile, invoked by `sam build`
via BuildMethod: makefile. This property verifies every pip install
invocation uses pip3, not bare pip.
"""
...
def test_property7_all_pip_commands_use_pip3(invocation):
    ...
    assert invocation == "pip3", "Found bare 'pip' instead of 'pip3' in Makefile"
